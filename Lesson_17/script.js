// ! обработка запросов в async / await с try/ catch
...
// выключаем loader добавляя ему класс hide
   ...
   //этот метод сработает только если class hide есть у контейнера
...
btnReset.addEventListener('click', () => {
    // показывает hide (когда этот класс есть)
    loader.classList.toggle('hide')
     // прячет  hide ( когда этого класса нет)
